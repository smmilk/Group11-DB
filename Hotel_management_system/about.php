...
<?php
  ...
  ?><br>
<div class="container-fluid text-center"style="padding-bottom:35px;">
<div class="container"> 
  <div class="row content">
    <div class="col-sm-12">
      <h1 id="font">SIT Hotels</h1><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <iframe class="frame"src="https://www.google.com/maps/embed/v1/place?q=Ang+Mo+Kio+Avenue+8,+Singapore+Institute+of+Technology+(SIT@NYP),+Singapore&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" width="550"height="300" frameborder="0" style="border:1" allowfullscreen></iframe>
      </div>
    </div>
  </div>
</div>      
<!--Map Close Here-->
        <div class="col-sm-2">
          <h4><b>Address</b></h4>
          <b>172 Ang Mo Kio Ave 8, Singapore 567739</b>
        </div>
        <div class="col-sm-2"style="background-color:#27303b;height:80px;width:100px;">
