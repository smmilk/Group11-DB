  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6 ">
        ...
        <div class="form-group">
            <div class="control-label col-sm-5"><h4>Email Address:</h4></div>
          <div class="col-sm-7">
              <input type="text" name="email" class="form-control"placeholder="Enter Your Email Address" autocomplete="off"required>
          </div>
        </div>
